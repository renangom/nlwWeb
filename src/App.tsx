...
function App() {
  ...
  return (
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-8 ">
      ...
      <div className='pt-1 bg-nlw-gradient self-stretch rounded-lg overflow-hidden mt-2'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center '>
          <div>
            <strong className='text-2xl text-white font-black'> Não encontrou seu duo? </strong>
            <span className='text-zinc-400 block'> Publique um anúncio para encontrar novos players </span>
          </div>
          <button className='py-3 px-4 gap-3 bg-violet-500 text-white rounded hover:bg-violet-600 flex items-center'>
